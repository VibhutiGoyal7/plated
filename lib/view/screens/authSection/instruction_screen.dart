              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("Create BD Pass Account",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                    SizedBox(height: 12,),
                    Row(
                      children: [
                    ...
                    Text("Sign up in 3 easy steps",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: Colors.white),),
                    SizedBox(height: 4,),
                    Text("The national digital identity for all citizens, residents and visitors.",style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold,color: Colors.white),),
                    SizedBox(height: 4,),
                    Text("1. Scan your ID",style: TextStyle(fontSize:14,color: Colors.white),),
                    Text("2. Verify your details",style: TextStyle(fontSize:14,color: Colors.white),),
                    Text("3. Secure your account",style: TextStyle(fontSize:14,color: Colors.white),),
                  ],
                ),
              ),
              isLoading
