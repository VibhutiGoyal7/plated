...
import '../../../model/db/PlatedDatabase.dart';
...
class _ChooseDocScreenState extends State<ChooseDocScreen> {
  bool isLoading = true;
  bool isCountryNameLoading = false;
  ...
  Future<void> intializeDatabase() async {
    database =
        await $FloorPlatedDatabase.databaseBuilder('PlatedDatabase.db').build();
        ...
        WidgetsBinding.instance.addPostFrameCallback((_) {
          setState(() {
            ...
            isNationalIdAvailable =
                (mediaList?.nationalIdImage?.availableForYourOrganization != null)
                    ? mediaList?.nationalIdImage?.availableForYourOrganization as bool
                    : false;
            isPassportAvailable =
                mediaList?.passportImage?.availableForYourOrganization != null
                    ? mediaList?.passportImage?.availableForYourOrganization as bool
                    : false;
            isDrivingLicenceAvailable =
                mediaList?.drivingLicenseImage?.availableForYourOrganization != null
                    ? mediaList?.drivingLicenseImage?.availableForYourOrganization as bool
                    : false;
            isAddressLycAvailable =
                mediaList?.addressKycData?.availableForYourOrganization != null
                    ? mediaList?.addressKycData?.availableForYourOrganization as bool
                    : false;
            isBankStatementAvailable =
                mediaList?.bankStatement?.availableForYourOrganization != null
                    ? mediaList?.bankStatement?.availableForYourOrganization as bool
                    : false;
            isGeoLocAvailable =
                mediaList?.geolocation?.availableForYourOrganization != null
                    ? mediaList?.geolocation?.availableForYourOrganization as bool
                    : false;
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          TextComponent(
                              text: "Nationality", fontSize: 16, isBold: true),
                        ],
                      ),
                    ),
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          TextComponent(
                              ...
                              isBold: true),
                          CustomTextComponent(
                              text: '(Please verify at-least one method)',
                              fontSize: 12,
                              fontColor:
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              CustomTextComponent(
                                  text: (nonCapitalizeString(status) ==
                                          nonCapitalizeString("rejected"))
                                      ? rejectionReason
                                      : subtitle,
                                  fontSize: 12,
                                  fontColor: (nonCapitalizeString(status) ==
                                          nonCapitalizeString("rejected"))
                                      ? textColor
                                      : isDarkMode
                                          ? Colors.white
