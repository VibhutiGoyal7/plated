...
part of 'BDPassDatabase.dart';

// **************************************************************************
// FloorGenerator
// **************************************************************************

abstract class $BDPassDatabaseBuilderContract {
  /// Adds migrations to the builder.
  $BDPassDatabaseBuilderContract addMigrations(List<Migration> migrations);

  /// Adds a database [Callback] to the builder.
  $BDPassDatabaseBuilderContract addCallback(Callback callback);

  /// Creates the database and initializes it.
  Future<BDPassDatabase> build();
}

// ignore: avoid_classes_with_only_static_members
class $FloorBDPassDatabase {
  /// Creates a database builder for a persistent database.
  /// Once a database is built, you should keep a reference to it and re-use it.
  static $BDPassDatabaseBuilderContract databaseBuilder(String name) =>
      _$BDPassDatabaseBuilder(name);

  /// Creates a database builder for an in memory database.
  /// Information stored in an in memory database disappears when the process is killed.
  /// Once a database is built, you should keep a reference to it and re-use it.
  static $BDPassDatabaseBuilderContract inMemoryDatabaseBuilder() =>
      _$BDPassDatabaseBuilder(null);
}

class _$BDPassDatabaseBuilder implements $BDPassDatabaseBuilderContract {
  _$BDPassDatabaseBuilder(this.name);
  ...
  @override
  Future<BDPassDatabase> build() async {
    final path = name != null
        ? await sqfliteDatabaseFactory.getDatabasePath(name!)
        : ':memory:';
    final database = _$BDPassDatabase();
...
class _$BDPassDatabase extends BDPassDatabase {
  _$BDPassDatabase([StreamController<String>? listener]) {
