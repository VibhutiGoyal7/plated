        ...
        child: Column(
          ...
          children: [
                    ...
                    GestureDetector(
                      ...
                      child: Stack(
                        children: [
                          Padding(
                            padding:
                            const EdgeInsets.only(right: 5.0, bottom: 3),
                            child: Container(
                                decoration: BoxDecoration(
            ...
            Padding(
              ...
              child: Column(
                children: [
                  LocationStopWidget( location: capitalizeFirstLetter(widget.data.pickup_address ?? ""), isPickUp: true,),
                  LocationStopWidget( location: capitalizeFirstLetter(widget.data.destination_address ?? ""), isPickUp: false,),
                ],
              ),
            ),
            SizedBox(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    margin: EdgeInsets.symmetric(horizontal: 5, vertical: 4),
                    padding:
                    EdgeInsets.symmetric(horizontal: 12.5, vertical: 9),
                    decoration: BoxDecoration(
                        border:
                        Border.all(color: Colors.blue.shade700, width: 0.5),
                        borderRadius: BorderRadius.circular(8),
