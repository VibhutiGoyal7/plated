...
class AboutPlatedScreen extends StatefulWidget {
  @override
  _AboutPlatedScreenState createState() => _AboutPlatedScreenState();
}

class _AboutPlatedScreenState extends State<AboutPlatedScreen> {
  String token = "";
