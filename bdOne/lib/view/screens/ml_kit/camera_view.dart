...
// Initialize the face detector
    _faceDetector = FaceDetector(
      options: FaceDetectorOptions(
        ...
        enableLandmarks: true, // Enable face landmarks
      ),
    );
    _initialize();
  }
    ...
    return ColoredBox(
      ...
      child: Stack(
        ...
        children: <Widget>[
          ...
          _backButton(),
          isFaceDetected ? _captureImageButton() : SizedBox()
...
/*  void _processCameraImage(CameraImage image) {
  ...
  void _processCameraImage(CameraImage image) async {
    if (_isDetectingFaces) return; // Prevent multiple detections at once
  ...
  Future<void> _captureImage() async {
    ...
    try {
      ...
      if (widget.onCaptured != null) {
        ...
        setState(() {
          imagePath = picture.path.toString();
        });
        print("onCaptured capturing image: ${picture.path}");
      }
...
Widget _exposureControl() => Positioned(
 ...
 // Capture the image when a face is detected
  void _captureImage(InputImage inputImage) {
    // You can trigger the capture event here, for example:
    widget.onImage(inputImage); // Pass the image to the parent widget

    // Optionally, you can stop the live feed or do additional processing here
