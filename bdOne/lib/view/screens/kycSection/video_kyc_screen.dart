      ...
      child: GestureDetector(
        ...
        child: Scaffold(
            appBar: AppBar(
              ...
              title: TextComponent(
                  text: "Verify your Identity", fontSize: 18, isBold: true),
                    ...
                    child: Column(
                      children: [
                        ...
                        CustomButtonComponent(
                            text:
                                isVideoRecorded ?  Languages.of(context)!.labelSubmit : "Start Recording",
    ...
    return Column(
      children: [
        ...
        Column(
          ...
          children: [
            TextComponent(text: "Record a video", fontSize: 24, isBold: true),
            SizedBox(
              height: 10,
            ),
            TextComponent(
                text: "This is to verify you are a real person",
                fontSize: 14,
                isBold: false),
            SizedBox(
              height: 6,
            ...
            TextComponent(
                text: "1. First position your face in the frame.",
                fontSize: 14,
                isBold: false),
            SizedBox(
              height: 6,
            ...
            TextComponent(
                text: "2. Then, turn your head slowly to both sides.",
                fontSize: 14,
                isBold: false),
          ],
        ),
