...
class RideServicesScreen extends StatefulWidget {
  @override
  _RideServicesScreenState createState() => _RideServicesScreenState();
}

class _RideServicesScreenState extends State<RideServicesScreen> {
  String? country;
