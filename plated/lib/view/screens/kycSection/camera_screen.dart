...
class _DocImageScreenState extends State<DocImageScreen> {
  ...
  Future<void> _uploadProfilePic(File file) async {
    ...
    print(file);
    DocumentData data =
        DocumentData(imageFile: file, docType: docType, imageName: imageName);
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            border: Border.all(
                width: 0.5, color: isDarkMode ? Colors.grey : Colors.black54)),
        child: imageClicked
            ? ClipRRect(
    ...
    return Container(
        ...
        child: label == "Front Side"
            ? SvgPicture.asset("assets/documet_front_side.svg",
              ...
              AppColor.PRIMARY_GREEN, BlendMode.srcIn),*/
