...
class RestaurantShopScreen extends StatefulWidget {
  @override
  _RestaurantShopScreenState createState() => _RestaurantShopScreenState();
}

class _RestaurantShopScreenState extends State<RestaurantShopScreen> {
