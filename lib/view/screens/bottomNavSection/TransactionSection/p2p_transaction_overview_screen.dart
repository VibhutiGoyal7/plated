...
class P2PTransactionOverviewScreen extends StatefulWidget {
  ...
  P2PTransactionOverviewScreen({required this.data});

  @override
  _P2PTransactionOverviewScreenState createState() =>
      _P2PTransactionOverviewScreenState();
}

class _P2PTransactionOverviewScreenState extends State<P2PTransactionOverviewScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    P2PTransactionDetails? transactionDetails = widget.data;
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        "${transactionDetails?.senderUsername}" != "null"
                            ? Column(
                                children: [
                                  Row(
                                    crossAxisAlignment:
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        "${transactionDetails?.senderUsername}",
                                        style: TextStyle(
                                          fontSize: 13,
                        ...
                        "${transactionDetails?.senderPhoneNumber}" != "null" ?
                            Column(
                              children: [
                                Row(
                                  crossAxisAlignment: CrossAxisAlignment.center,
                            ...
                            :SizedBox(),
                        "${transactionDetails?.receiverUsername}" != "null"
                            ? Column(
                          children: [
                            Row(
                              crossAxisAlignment:
                              ...
                              children: [
                                ...
                                Text(
                                  "${transactionDetails?.receiverUsername}",
                                  style: TextStyle(
                                    fontSize: 13,
                                    fontWeight: FontWeight.bold,
                                  ),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              "${transactionDetails?.receiverPhoneNumber}",
                              style: TextStyle(
                                fontSize: 13,
                                fontWeight: FontWeight.bold,
                              ),
                        ...
                        IntrinsicWidth(
                          child: GestureDetector(
                            onTap: (){
                              Navigator.of(context).pushNamed("/P2PTransactionReceiptScreen", arguments: widget.data);
                            },
                            child: Column(
                              children: [
                                Text(
