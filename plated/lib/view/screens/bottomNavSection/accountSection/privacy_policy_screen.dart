...
import 'package:Plated/model/response/trxStatusResponse.dart';
...
class PrivacyPolicyScreen extends StatefulWidget {
  ...
  PrivacyPolicyScreen({Key? key, this.data}) : super(key: key);
...
class _PrivacyPolicyScreenState extends State<PrivacyPolicyScreen> {
  ...
  Future<Widget> getTrxStatusResponse(
    ...
    TrxStatusResponse? addMoneyResponse =
        apiResponse.data as TrxStatusResponse?;
    setState(() {
      isLoading = false;
    });
  ...
  ''';
    ...
    controller
      ...
      //..clearCache()
      ..runJavaScriptReturningResult(jsScript).then((result) {
